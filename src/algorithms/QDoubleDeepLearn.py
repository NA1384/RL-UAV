...
class DQNAgent:
    def __init__(self, inputs, outputs, learningRate, minReplay, replay, batch, gamma, update, loadModel, loadMemory, stateDepth):
        ...
        if(self.loadModel):
            ...
            print("\nModel Loaded!\n")
        # Target network used for predicting, not updated every step
        ...
        # This number is the amount of epochs before the target Net will take over the other nets weights
